...
namespace WAZOI.Backend.DAL.Migrations
{
    ...
    [Migration("20220830231657_grading-criteria")]
    partial class gradingcriteria
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WAZOI.Backend.DAL.Entities.Exam", b =>
                {
                    ...
                    b.Property<Guid>("SubjectGradingCriteriaId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SubjectGradingCriteriaId");
            ...
            modelBuilder.Entity("WAZOI.Backend.DAL.Entities.SubjectGradingCriteria", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("SubjectGradingCriteria");
                });
            ...
            modelBuilder.Entity("WAZOI.Backend.DAL.Entities.Exam", b =>
                {
                    b.HasOne("WAZOI.Backend.DAL.Entities.SubjectGradingCriteria", "GradingCriterion")
                        .WithMany()
                        .HasForeignKey("SubjectGradingCriteriaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WAZOI.Backend.DAL.Entities.SubjectGradingCriteria", b =>
                {
                    b.HasOne("WAZOI.Backend.DAL.Entities.Subject", null)
                        .WithOne("SubjectGradingCriteria")
                        .HasForeignKey("WAZOI.Backend.DAL.Entities.SubjectGradingCriteria", "SubjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("WAZOI.Backend.DAL.Entities.Subject", b =>
                {
                    ...
                    b.Navigation("SubjectGradingCriteria")
                        .IsRequired();
