...
namespace WAZOI.Backend.DAL.Migrations
{
    ...
    [Migration("20220624152104_elephantsql")]
            ...
            modelBuilder.Entity("WAZOI.Backend.DAL.Entities.SubjectStudent", b =>
                {
                    ...
                    b.HasOne("WAZOI.Backend.DAL.Entities.User", "User")
                        .WithOne("SubjectStudent")
                        .HasForeignKey("WAZOI.Backend.DAL.Entities.SubjectStudent", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WAZOI.Backend.DAL.Entities.SubjectTeacher", b =>
                {
                    ...
                    b.HasOne("WAZOI.Backend.DAL.Entities.User", "User")
                        .WithOne("SubjectTeacher")
                        .HasForeignKey("WAZOI.Backend.DAL.Entities.SubjectTeacher", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
